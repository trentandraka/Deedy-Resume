...
\item Improved site performance by 18\% (per Google PageSpeed Insights)
\end{tightemize}
\sectionsep
...
\begin{tightemize}
\item Coordinator for the \#1 HealthTech hackathon in the US (500+ students)
...
\descript{}
\location{\href{http://github.com/trentandraka/activity-tracker}{https://github.com/trentandraka/activity-tracker}}
\begin{tightemize}
...
\runsubsection{WUSTL API}
\descript{}
\location{(Still under development)}
\begin{tightemize}
\item Developing an API in \custombold{Python} to easily interface with open data from Wash U
\item Will be able to access course, study room, and laundry machine data
\end{tightemize}
\sectionsep
